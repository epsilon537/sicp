...
;A: A squarer is also a squarerooter. The squareroot direction: sqrt(b)->a won't work because the multiplier only sees one value (b) and expects two values to compute a third value.
;An implementation with only two terminals is needed.
